...
export function Hero() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-24 pb-16 text-center z-10">
      ...
      <h1 className="mt-6 max-w-4xl font-heading text-4xl font-bold tracking-tight text-balance sm:text-6xl lg:text-7xl">
        Forecast & Simulate <span className="text-primary">NEO Collisions</span>{" "}
        in 3D
      </h1>

      <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground text-pretty sm:text-lg">
        An interactive research platform for predicting near-Earth object impact
        trajectories and visualizing collision scenarios in a fully rendered
